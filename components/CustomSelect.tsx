    ...
    <div ref={rootRef} className={`relative inline-flex ${className}`}>
      ...
      {open && (
        <ul
          role="listbox"
          aria-label={label}
          className={`absolute top-full z-30 mt-2 min-w-[200px] animate-fade-down overflow-hidden border border-[#E5DDD0] bg-white shadow-[0_18px_40px_-20px_rgba(20,75,60,0.45)] ${
